...
with open(nota2,"w",encoding="utf-8") as f2:
    f2.write("Questa è un'altra riga in un altro file\n")

with open(nota2,"a",encoding="utf-8") as f2:
    f2.write("Questa è un'altra riga ancora")

with open(to_rename,"w",encoding="utf-8") as f3:
    f3.write("Questa è una ennesima riga")

#5 Elenca i file presenti in notes/ con os.listdir(...) e stampa solo quelli che terminano con .txt.
...
with open(index_path,"r",encoding="utf-8") as index_json:
